...
export class FollowersUtils {
  ...
  static updateSingleUser(users, userData, followersData, setUsers) {
    users = cloneDeep(users);
    userData.followersCount = followersData.followersCount;
    userData.followingCount = followersData.followingCount;
    userData.postsCount = followersData.postsCount;
